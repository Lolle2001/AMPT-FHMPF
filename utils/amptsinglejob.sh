...
# SHOULD ALSO BE DONE FOR HIJING SEED, INSTEAD OF LETTING AMPT DO IT ONE RUNTIME
# THAT WOULD PREVENT THE HIJING SEEDS TO BE THE SAME FOR ALLE THREADS WHICH WILL START
# AT THE SAME RUNTIME.
